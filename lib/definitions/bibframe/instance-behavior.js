...
// editionStatement -> literal
InstanceBehavior.editionStatement = makeGet('bf:editionStatement')
InstanceBehavior.setEditionStatement = makeSet('bf:editionStatement')
// editionEnumeration -> literal
InstanceBehavior.editionEnumeration = makeGet('bf:editionEnumeration')
InstanceBehavior.setEditionEnumeration = makeSet('bf:editionEnumeration')
// seriesStatement -> Literal
InstanceBehavior.seriesStatement = makeGet('bf:seriesStatement')
InstanceBehavior.setSeriesStatement = makeSet('bf:seriesStatement')
// seriesEnumeration -> Literal
InstanceBehavior.seriesEnumeration = makeGet('bf:seriesEnumeration')
InstanceBehavior.setSeriesEnumeration = makeSet('bf:seriesEnumeration')
// subseriesEnumeration -> Literal
// subseriesStatement -> Literal
