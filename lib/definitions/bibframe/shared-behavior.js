...
// agent -> Agent
SharedBehavior.getAgent = makeGet('bf:agent')
SharedBehavior.setAgent = makeSet('bf:agent')
...
// language -> Language
SharedBehavior.language = makeGetLabelFromNode('bf:language', 'bf:Language')
SharedBehavior.setLanguage = makeSetAsLabelOnType('bf:language', 'bf:Language')
SharedBehavior.removeLanguage = makeRemove('bf:language')

// note -> Note
SharedBehavior.note = makeGetLabelFromNode('bf:note', 'bf:Note')
SharedBehavior.setNote = makeSetAsLabelOnType('bf:note', 'bf:Note')
...
SharedBehavior.setSource = makeSetAsLabelOnType('bf:source', 'bf:Source')
SharedBehavior.source = makeGetLabelFromNode('bf:source', 'bf:Source')
...
SharedBehavior.setStatus = makeSetAsLabelOnType('bf:status', 'bf:Status')
SharedBehavior.status = makeGetLabelFromNode('bf:status', 'bf:Status')
