...
SharedBehavior.getIdentifier = makeGet('bf:identifiedBy')
SharedBehavior.getIdentifiers = makeAll('bf:identifiedBy')
SharedBehavior.addIdentifier = makeAdd('bf:identifiedBy')
SharedBehavior.removeDate = makeRemove('bf:identifiedBy')

SharedBehavior.addIsbn = function () {}
SharedBehavior.addDoi = function () {}
SharedBehavior.IssnL = function () {}
SharedBehavior.Issn = function () {}
// language -> Language
