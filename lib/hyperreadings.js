...
function HyperReadings (storage, key, opts) {
  ...
  this.network = null
  this._nodeCount = 0
  this.graph = hypergraph(storage, opts)
...
HyperReadings.prototype.joinNetwork = function () {
  if (!this.swarm) {
  ...
  this.network = this.swarm(this.graph.db)
  return this.network
}

HyperReadings.prototype.leaveNetwork = function () {
