...
HyperReadings.prototype.findPeople = async function (opts) {
  ...
  if (opts && opts.name) query.push(spo(v('id'), 'foaf:name', opts.name))
  if (opts && opts.firstName) query.push(spo(v('id'), 'foaf:firstName', opts.firstName))
  if (opts && opts.lastName) query.push(spo(v('id'), 'foaf:lastName', opts.lastName))
